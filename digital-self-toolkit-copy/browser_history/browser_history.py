...
def save_browser_history_data(history_entries: list):
    ...
    if supabase_client:
        ...
        if result and result.data:
            ...
            # )
            save_data_to_json(
                history_entries, "chrome_history", "browser_history/data", overwrite=True
            )

    else:
        print("Supabase not configured, saving to JSON...")
        save_data_to_json(history_entries, "chrome_history", "browser_history/data",overwrite=True)
